...
function(process_gen_id){
  ...
  Function_relF<-function(F0){
    abs(true_quote-sum(true_N_1*(1-exp(-F0*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e+comp_recr_discard_e) - comp_bycatch_e - M_1_true))*
                        (F0*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e+comp_recr_discard_e) + comp_bycatch_e)/
                        (F0*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e+comp_recr_discard_e) + comp_bycatch_e + M_1_true) +
                      true_N_2*(1-exp(-F0*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w+comp_recr_discard_w) - comp_bycatch_w - M_2_true))*
                        (F0*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w+comp_recr_discard_w) + comp_bycatch_w)/
                        (F0*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w+comp_recr_discard_w) + comp_bycatch_w + M_2_true)))
  }

  Function_relF_imple<-function(v){
    F1<-v[1]
    F2<-v[2]
    abs(Comme_planned_catch-sum(true_N_1*(1-exp(-F1*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e_true +comp_recr_discard_e_true ) - comp_bycatch_e - M_1_true))*F1*comp_comm_sel_e/(F1*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e_true +comp_recr_discard_e_true ) + comp_bycatch_e + M_1_true) * weight_at_age_1 + true_N_2*(1-exp(-F1*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w_true +comp_recr_discard_w_true ) - comp_bycatch_w - M_2_true))*F1*comp_comm_sel_w/(F1*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w_true +comp_recr_discard_w_true ) + comp_bycatch_w + M_2_true) * weight_at_age_2))+abs(Recre_planned_catch-sum(true_N_1*(1-exp(-F2*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e_true +comp_recr_discard_e_true ) - comp_bycatch_e - M_1_true))*F2*comp_recr_sel_e/(F2*(comp_comm_sel_e+comp_recr_sel_e + comp_comm_discard_e_true +comp_recr_discard_e_true ) + comp_bycatch_e + M_1_true) * weight_at_age_1 +true_N_2*(1-exp(-F2*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w_true +comp_recr_discard_w_true) - comp_bycatch_w - M_2_true))*F2*comp_recr_sel_w/(F2*(comp_comm_sel_w+comp_recr_sel_w + comp_comm_discard_w_true +comp_recr_discard_w_true ) + comp_bycatch_w + M_2_true) * weight_at_age_2))  
  }
  ...
  for (i.run in 1:Simrun_Num){
    ...
    for (i.runtime in 1:Runtime_short){
      ...
      relF<-optimize(Function_relF,c(0,10))$minimum
  ...
  for (i.run in 1:Simrun_Num){
    ...
    for (i.runtime in 1:Runtime_long){
      ...
      comm_relF_imple<-max(relF_imple[1],0)
      recr_relF_imple<-max(relF_imple[2],0)
  ...
  total_catch_mean_MSEcomp<-mean(total_catch_MSEcomp)*2.2046
  total_catch_upper_MSEcomp<-mean(total_catch_MSEcomp)*2.2046+sd(total_catch_MSEcomp)*2.2046
  total_catch_lower_MSEcomp<-mean(total_catch_MSEcomp)*2.2046-sd(total_catch_MSEcomp)*2.2046
  ...
  catch_var_mean_MSEcomp<-mean(catch_var_MSEcomp)
  catch_var_upper_MSEcomp<-mean(catch_var_MSEcomp)+sd(catch_var_MSEcomp)
  catch_var_lower_MSEcomp<-mean(catch_var_MSEcomp)-sd(catch_var_MSEcomp)
  #calculate variation from Simrun_Num of results

  #Figure 5 Basic simple with variation
  terminal_SSB_MSEcomp<-total_SSB[,ncol(total_SSB)]
  terminal_SSB_mean_MSEcomp<-mean(terminal_SSB_MSEcomp)
  terminal_SSB_upper_MSEcomp<-mean(terminal_SSB_MSEcomp)+sd(terminal_SSB_MSEcomp)
  terminal_SSB_lower_MSEcomp<-mean(terminal_SSB_MSEcomp)-sd(terminal_SSB_MSEcomp)
  #calculate variation from Simrun_Num of results

  #Figure 6 Basic simple with variation
  lowest_SSB_MSEcomp<-rowMins(total_SSB) 
  lowest_SSB_mean_MSEcomp<-mean(lowest_SSB_MSEcomp)
  lowest_SSB_upper_MSEcomp<-mean(lowest_SSB_MSEcomp)+sd(lowest_SSB_MSEcomp)
  lowest_SSB_lower_MSEcomp<-mean(lowest_SSB_MSEcomp)-sd(lowest_SSB_MSEcomp)
  #calculate variation from Simrun_Num of results
  ...
  total_discards_mean_MSEcomp<-mean(total_discards_MSEcomp)*2.2046
  total_discards_upper_MSEcomp<-mean(total_discards_MSEcomp)*2.2046+sd(total_discards_MSEcomp)*2.2046
  total_discards_lower_MSEcomp<-mean(total_discards_MSEcomp)*2.2046-sd(total_discards_MSEcomp)*2.2046
  ...
  discards_var_mean_MSEcomp<-mean(discards_var_MSEcomp)
  discards_var_upper_MSEcomp<-mean(discards_var_MSEcomp)+sd(discards_var_MSEcomp)
  discards_var_lower_MSEcomp<-mean(discards_var_MSEcomp)-sd(discards_var_MSEcomp)
  ...
  total_SSB_first5mean<-rowMeans(total_SSB[,1:5])
  total_SSB_first5mean_mean<-mean(total_SSB_first5mean)
  total_SSB_first5mean_upper<-mean(total_SSB_first5mean)+sd(total_SSB_first5mean)
  total_SSB_first5mean_lower<-mean(total_SSB_first5mean)-sd(total_SSB_first5mean)

  #Figure 5 Basic bar simple with variation
  total_SSB_last5mean<-rowMeans(total_SSB[,(Runtime_long-4):Runtime_long])
  total_SSB_last5mean_mean<-mean(total_SSB_last5mean)
  total_SSB_last5mean_upper<-mean(total_SSB_last5mean)+sd(total_SSB_last5mean)
  total_SSB_last5mean_lower<-mean(total_SSB_last5mean)-sd(total_SSB_last5mean)

  #Figure 6 Bar label rotation, maybe with variation?
  Forhire_catch_first5mean<-mean(rowMeans(Forhire_catch[,1:5]))*2.2046
  Private_catch_first5mean<-mean(rowMeans(Private_catch[,1:5]))*2.2046
  Forhire_catch_last5mean<-mean(rowMeans(Forhire_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  Private_catch_last5mean<-mean(rowMeans(Private_catch[,(Runtime_long-4):Runtime_long]))*2.2046

  #Figure 7 Bar label rotation, maybe with variation?
  true_private_AL_catch_first5mean<-mean(rowMeans(true_private_AL_catch[,1:5]))*2.2046
  true_private_FL_catch_first5mean<-mean(rowMeans(true_private_FL_catch[,1:5]))*2.2046
  true_private_LA_catch_first5mean<-mean(rowMeans(true_private_LA_catch[,1:5]))*2.2046
  true_private_MS_catch_first5mean<-mean(rowMeans(true_private_MS_catch[,1:5]))*2.2046
  true_private_TX_catch_first5mean<-mean(rowMeans(true_private_TX_catch[,1:5]))*2.2046

  #Figure 8 Bar label rotation, maybe with variation?
  true_private_AL_catch_last5mean<-mean(rowMeans(true_private_AL_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  true_private_FL_catch_last5mean<-mean(rowMeans(true_private_FL_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  true_private_LA_catch_last5mean<-mean(rowMeans(true_private_LA_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  true_private_MS_catch_last5mean<-mean(rowMeans(true_private_MS_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  true_private_TX_catch_last5mean<-mean(rowMeans(true_private_TX_catch[,(Runtime_long-4):Runtime_long]))*2.2046

  #Figure 9 Bar label rotation, maybe with variation?
  true_private_AL_season_length_first5mean<-mean(rowMeans(true_private_AL_season_length[,1:5]))
  true_private_FL_season_length_first5mean<-mean(rowMeans(true_private_FL_season_length[,1:5]))
  true_private_LA_season_length_first5mean<-mean(rowMeans(true_private_LA_season_length[,1:5]))
  true_private_MS_season_length_first5mean<-mean(rowMeans(true_private_MS_season_length[,1:5]))
  true_private_TX_season_length_first5mean<-mean(rowMeans(true_private_TX_season_length[,1:5]))

  #Figure 10 Bar label rotation, maybe with variation?
  true_private_AL_season_length_last5mean<-mean(rowMeans(true_private_AL_season_length[,(Runtime_long-4):Runtime_long]))
  true_private_FL_season_length_last5mean<-mean(rowMeans(true_private_FL_season_length[,(Runtime_long-4):Runtime_long]))
  true_private_LA_season_length_last5mean<-mean(rowMeans(true_private_LA_season_length[,(Runtime_long-4):Runtime_long]))
  true_private_MS_season_length_last5mean<-mean(rowMeans(true_private_MS_season_length[,(Runtime_long-4):Runtime_long]))
  true_private_TX_season_length_last5mean<-mean(rowMeans(true_private_TX_season_length[,(Runtime_long-4):Runtime_long]))

  #Figure 11 Basic bar simple with variation
  total_catch_first5mean<-rowMeans(total_catch[,1:5])*2.2046
  total_catch_first5mean_mean<-mean(total_catch_first5mean)*2.2046
  total_catch_first5mean_upper<-mean(total_catch_first5mean)*2.2046+sd(total_catch_first5mean)*2.2046
  total_catch_first5mean_lower<-mean(total_catch_first5mean)*2.2046-sd(total_catch_first5mean)*2.2046

  #Figure 12 Basic bar simple with variation
  total_catch_last5mean<-rowMeans(total_catch[,(Runtime_long-4):Runtime_long])*2.2046
  total_catch_last5mean_mean<-mean(total_catch_last5mean)*2.2046
  total_catch_last5mean_upper<-mean(total_catch_last5mean)*2.2046+sd(total_catch_last5mean)*2.2046
  total_catch_last5mean_lower<-mean(total_catch_last5mean)*2.2046-sd(total_catch_last5mean)*2.2046
  ...
  comm_catch_first5mean_MSEcomp<-median(rowMeans(comm_catch[,1:5]))*2.2046
  comm_catch_last5mean_MSEcomp<-median(rowMeans(comm_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  total_SSB_last5mean_MSEcomp<-median(rowMeans(total_SSB[,(Runtime_long-4):Runtime_long]))
  percent_green_MSEcomp<-sum(Year_green>0)/(Simrun_Num*Runtime_long)
  ...
  Forhire_catch_first5mean_MSEcomp<-median(rowMeans(Forhire_catch[,1:5]))*2.2046
  Private_catch_first5mean_MSEcomp<-median(rowMeans(Private_catch[,1:5]))*2.2046
  Forhire_catch_last5mean_MSEcomp<-median(rowMeans(Forhire_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  Private_catch_last5mean_MSEcomp<-median(rowMeans(Private_catch[,(Runtime_long-4):Runtime_long]))*2.2046
  total_SSB_last5mean_MSEcomp<-median(rowMeans(total_SSB[,(Runtime_long-4):Runtime_long]))
  percent_green_MSEcomp<-sum(Year_green>0)/(Simrun_Num*Runtime_long)
  ...
  mseCompFields <- paste('{"total_catch_mean_MSEcomp":',toJSON_scalar(total_catch_mean_MSEcomp),',"total_catch_upper_MSEcomp":',toJSON_scalar(total_catch_upper_MSEcomp),',"total_catch_lower_MSEcomp":',toJSON_scalar(total_catch_lower_MSEcomp)
                          ,',"catch_var_mean_MSEcomp":',toJSON_scalar(catch_var_mean_MSEcomp),',"catch_var_upper_MSEcomp":',toJSON_scalar(catch_var_upper_MSEcomp),',"catch_var_lower_MSEcomp":',toJSON_scalar(catch_var_lower_MSEcomp)
                          ,',"terminal_SSB_mean_MSEcomp":',toJSON_scalar(terminal_SSB_mean_MSEcomp),',"terminal_SSB_upper_MSEcomp":',toJSON_scalar(terminal_SSB_upper_MSEcomp),',"terminal_SSB_lower_MSEcomp":',toJSON_scalar(terminal_SSB_lower_MSEcomp)
                          ,',"lowest_SSB_mean_MSEcomp":',toJSON_scalar(lowest_SSB_mean_MSEcomp),',"lowest_SSB_upper_MSEcomp":',toJSON_scalar(lowest_SSB_upper_MSEcomp),',"lowest_SSB_lower_MSEcomp":',toJSON_scalar(lowest_SSB_lower_MSEcomp),',"percent_green_MSEcomp":',toJSON_scalar(percent_green_MSEcomp)
                          ...
                          ,',"total_discards_mean_MSEcomp":',toJSON_scalar(total_discards_mean_MSEcomp),',"total_discards_upper_MSEcomp":',toJSON_scalar(total_discards_upper_MSEcomp),',"total_discards_lower_MSEcomp":',toJSON_scalar(total_discards_lower_MSEcomp)
                          ,',"discards_var_mean_MSEcomp":',toJSON_scalar(discards_var_mean_MSEcomp),',"discards_var_upper_MSEcomp":',toJSON_scalar(discards_var_upper_MSEcomp),',"discards_var_lower_MSEcomp":',toJSON_scalar(discards_var_lower_MSEcomp)
                          ,',"total_SSB_first5mean_mean":',toJSON_scalar(total_SSB_first5mean_mean),',"total_SSB_first5mean_upper":',toJSON_scalar(total_SSB_first5mean_upper),',"total_SSB_first5mean_lower":',toJSON_scalar(total_SSB_first5mean_lower)
                          ,',"total_SSB_last5mean_mean":',toJSON_scalar(total_SSB_last5mean_mean),',"total_SSB_last5mean_upper":',toJSON_scalar(total_SSB_last5mean_upper),',"total_SSB_last5mean_lower":',toJSON_scalar(total_SSB_last5mean_lower)
                          ,',"Forhire_catch_first5mean":',toJSON_scalar(Forhire_catch_first5mean),',"Private_catch_first5mean":',toJSON_scalar(Private_catch_first5mean),',"Forhire_catch_last5mean":',toJSON_scalar(Forhire_catch_last5mean),',"Private_catch_last5mean":',toJSON_scalar(Private_catch_last5mean)
                          ,',"true_private_AL_catch_first5mean":',toJSON_scalar(true_private_AL_catch_first5mean),',"true_private_FL_catch_first5mean":',toJSON_scalar(true_private_FL_catch_first5mean),',"true_private_LA_catch_first5mean":',toJSON_scalar(true_private_LA_catch_first5mean),',"true_private_MS_catch_first5mean":',toJSON_scalar(true_private_MS_catch_first5mean),',"true_private_TX_catch_first5mean":',toJSON_scalar(true_private_TX_catch_first5mean)
                          ,',"true_private_AL_catch_last5mean":',toJSON_scalar(true_private_AL_catch_last5mean),',"true_private_FL_catch_last5mean":',toJSON_scalar(true_private_FL_catch_last5mean),',"true_private_LA_catch_last5mean":',toJSON_scalar(true_private_LA_catch_last5mean),',"true_private_MS_catch_last5mean":',toJSON_scalar(true_private_MS_catch_last5mean),',"true_private_TX_catch_last5mean":',toJSON_scalar(true_private_TX_catch_last5mean)
                          ,',"true_private_AL_season_length_first5mean":',toJSON_scalar(true_private_AL_season_length_first5mean),',"true_private_FL_season_length_first5mean":',toJSON_scalar(true_private_FL_season_length_first5mean),',"true_private_LA_season_length_first5mean":',toJSON_scalar(true_private_LA_season_length_first5mean),',"true_private_MS_season_length_first5mean":',toJSON_scalar(true_private_MS_season_length_first5mean),',"true_private_TX_season_length_first5mean":',toJSON_scalar(true_private_TX_season_length_first5mean)
                          ,',"true_private_AL_season_length_last5mean":',toJSON_scalar(true_private_AL_season_length_last5mean),',"true_private_FL_season_length_last5mean":',toJSON_scalar(true_private_FL_season_length_last5mean),',"true_private_LA_season_length_last5mean":',toJSON_scalar(true_private_LA_season_length_last5mean),',"true_private_MS_season_length_last5mean":',toJSON_scalar(true_private_MS_season_length_last5mean),',"true_private_TX_season_length_last5mean":',toJSON_scalar(true_private_TX_season_length_last5mean)
                          ,',"total_catch_first5mean_mean":',toJSON_scalar(total_catch_first5mean_mean),',"total_catch_first5mean_upper":',toJSON_scalar(total_catch_first5mean_upper),',"total_catch_first5mean_lower":',toJSON_scalar(total_catch_first5mean_lower)
                          ,',"total_catch_last5mean_mean":',toJSON_scalar(total_catch_last5mean_mean),',"total_catch_last5mean_upper":',toJSON_scalar(total_catch_last5mean_upper),',"total_catch_last5mean_lower":',toJSON_scalar(total_catch_last5mean_lower)
                          ,',"comm_discards_median":',toJSON(comm_discards_median),',"recr_discards_median":',toJSON(recr_discards_median),',"comm_catch_var_MSEcomp":',toJSON_scalar(comm_catch_var_MSEcomp),',"comm_catch_first5mean_MSEcomp":',toJSON_scalar(comm_catch_first5mean_MSEcomp)
                          ,',"comm_catch_last5mean_MSEcomp":',toJSON_scalar(comm_catch_last5mean_MSEcomp),',"total_SSB_last5mean_MSEcomp":',toJSON_scalar(total_SSB_last5mean_MSEcomp),',"comm_disalloratio_ave20_MSEcomp":',toJSON_scalar(comm_disalloratio_ave20_MSEcomp),',"comm_disalloratio_ave20_MSEcomp":',toJSON_scalar(comm_disalloratio_ave20_MSEcomp)
                          ,',"recr_catch_var_MSEcomp":',toJSON_scalar(recr_catch_var_MSEcomp),',"Forhire_catch_first5mean_MSEcomp":',toJSON_scalar(Forhire_catch_first5mean_MSEcomp),',"Private_catch_first5mean_MSEcomp":',toJSON_scalar(Private_catch_first5mean_MSEcomp),',"Forhire_catch_last5mean_MSEcomp":',toJSON_scalar(Forhire_catch_last5mean_MSEcomp),',"Private_catch_last5mean_MSEcomp":',toJSON_scalar(Private_catch_last5mean_MSEcomp),',"recr_disalloratio_ave20_MSEcomp":',toJSON_scalar(recr_disalloratio_ave20_MSEcomp)
                          ,'}',sep = "")
